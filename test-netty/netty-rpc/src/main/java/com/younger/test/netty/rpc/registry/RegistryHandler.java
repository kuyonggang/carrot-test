...
import com.younger.test.netty.rpc.core.msg.InvokerMsg;
...
public class RegistryHandler extends ChannelInboundHandlerAdapter {
    ...
    private String servicePack = "com.younger.test.netty.rpc.provider";


    public RegistryHandler() {
        scanClass(servicePack);
        doRegister();
    }
